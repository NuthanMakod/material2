  ...
  describe('core', () => {
    ...
    describe('overlay panel', () => {
      ...
      it('should be able to set extra classes on the panel', fakeAsync(() => {
        ...
        const panel = overlayContainerElement.querySelector('.mat-select-content') as HTMLElement;
    ...
    describe('animations', () => {
      ...
      it('should add a class to the panel when the menu is done animating', fakeAsync(() => {
        ...
        const panel = overlayContainerElement.querySelector('.mat-select-content')!;
  ...
  describe('positioning', () => {
    ...
    describe('limited space to open horizontally', () => {
      ...
      it('should stay within the viewport when overflowing on the left in ltr', fakeAsync(() => {
        ...
        const panelLeft = document.querySelector('.mat-select-content')!.getBoundingClientRect().left;
